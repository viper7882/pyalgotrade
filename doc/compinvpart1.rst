...
Download the data with the following commands: ::
    ...
    python -c "from pyalgotrade.tools import googlefinance; googlefinance.download_daily_bars('aeti', 2011, 'aeti-2011-googlefinance.csv')"
    python -c "from pyalgotrade.tools import googlefinance; googlefinance.download_daily_bars('egan', 2011, 'egan-2011-googlefinance.csv')"
    python -c "from pyalgotrade.tools import googlefinance; googlefinance.download_daily_bars('glng', 2011, 'glng-2011-googlefinance.csv')"
    python -c "from pyalgotrade.tools import googlefinance; googlefinance.download_daily_bars('simo', 2011, 'simo-2011-googlefinance.csv')"
